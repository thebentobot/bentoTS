...
export const command: Command = {
    ...
    run: async (client, message, args): Promise<Message> => {
        ...
        async function userFunction (message: Message, user: User | GuildMember) {
            ...
            let lastfmStatus: boolean = false
            ...
            let xpBoard: boolean = true // xpboard is enabled by default
            ...
            let fmOpacity: string = 100
            let xpOpacity: string = 100

            let descriptionHeight: string = "250px"
            // normal height is 250px

            let fmPaddingTop: string = "32.5px"
            ...
            // sidebar 
            const usernameColour = userProfileData ? (userProfileData.usernameColour !== null ? userProfileData.usernameColour : '#ffffff') : '#ffffff'
            const discriminatorColour = userProfileData ? (userProfileData.discriminatorColour !== null ? userProfileData.discriminatorColour : '#9CA3AF') : '#9CA3AF'
            
            const sidebarItemServerColour = userProfileData ? (userProfileData.sidebarItemServerColour !== null ? userProfileData.sidebarItemServerColour : "#D3D3D3") : "#D3D3D3"
            const sidebarItemGlobalColour = userProfileData ? (userProfileData.sidebarItemGlobalColour !== null ? userProfileData.sidebarItemGlobalColour : "#D3D3D3") : "#D3D3D3"
            const sidebarItemBentoColour = userProfileData ? (userProfileData.sidebarItemBentoColour !== null ? userProfileData.sidebarItemBentoColour : "#D3D3D3") : "#D3D3D3"
            const sidebarItemTimezoneColour = userProfileData ? (userProfileData.sidebarItemTimezoneColour !== null ? userProfileData.sidebarItemTimezoneColour : "#D3D3D3") : "#D3D3D3"
            const sidebarValueServerColour = userProfileData ? (userProfileData.sidebarValueServerColour !== null ? userProfileData.sidebarValueServerColour : '#ffffff') : "#ffffff"
            const sidebarValueGlobalColour = userProfileData ? (userProfileData.sidebarValueGlobalColour !== null ? userProfileData.sidebarValueGlobalColour : '#ffffff') : "#ffffff"
            ...
            const xpDoneServerColour3Data = userProfileData ? (userProfileData.xpDoneServerColour3 !== null ? userProfileData.xpDoneServerColour3 : "#EF4444") : "#EF4444"
            const xpDoneGlobalColour1Data = userProfileData ? (userProfileData.xpDoneGlobalColour1 !== null ? userProfileData.xpDoneGlobalColour1 : "#FCD34D") : "#FCD34D"
            const xpDoneGlobalColour2Data = userProfileData ? (userProfileData.xpDoneGlobalColour2 !== null ? userProfileData.xpDoneGlobalColour2 : "#F59E0B") : "#F59E0B"
            const xpDoneGlobalColour3Data = userProfileData ? (userProfileData.xpDoneGlobalColour3 !== null ? userProfileData.xpDoneGlobalColour3 : "#EF4444") : "#EF4444"
            ...
            const replacements = {
                ...
                "DESCRIPTION": userProfileData ? (userProfileData.description !== null ? userProfileData.description : "I am a happy user of Bento 🍱😄") : "I am a happy user of Bento 🍱😄",
            ...
            const userTimezone = userProfileData ? (userProfileData.timezone !== null ? moment().tz(userProfileData.timezone).format('ddd, h:mmA') : '') : ''
            const userBirthday = userProfileData ? (userProfileData.birthday !== null ? (userTimezone ? `, ${moment(new Date(userProfileData.birthday)).format('MMM D')} 🎂` : `${moment(new Date(userProfileData.birthday)).format('MMM D')} 🎂`) : '') : ''
            ...
            let patreonsData = await patreon.findAll()

            if (patreonsData.some(user => user.userID == userID)) {
                emoteArray.push(emoteFunction('https://www.audiosocket.com/wp-content/uploads/2020/11/patreon-creators-patreon.png'))
                const patreonUser = patreonsData.filter(user => user.userID == userID)
                if (patreonUser[0].emoteSlot1 !== null) {
                    emoteArray.push(emoteFunction(patreonUser[0].emoteSlot1))
                }

                if (patreonUser[0].emoteSlot2 !== null && patreonUser[0].enthusiast === true || patreonUser[0].disciple === true || patreonUser[0].sponsor === true) {
                    emoteArray.push(emoteFunction(patreonUser[0].emoteSlot2))
                }

                if (patreonUser[0].emoteSlot3 !== null && patreonUser[0].disciple === true || patreonUser[0].sponsor === true) {
                    emoteArray.push(emoteFunction(patreonUser[0].emoteSlot3))
                }

                if (patreonUser[0].emoteSlot4 !== null && patreonUser[0].sponsor === true) {
                    emoteArray.push(emoteFunction(patreonUser[0].emoteSlot4))
                }
            }
            ...
            .fmArtistText {
                ...
                overflow: hidden;
                font-family: 'Urbanist', sans-serif;
                font-size: ${lastfmTextFunction(usernameEmbed ? usernameEmbed.recenttracks.track[0].artist['#text'] : 'lmao')};
                padding-left: 10px;
                display: flex;
                align-items: center;
