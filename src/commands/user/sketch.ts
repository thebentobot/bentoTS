...
export const command: Command = {
    ...
    run: async (client, message, args): Promise<any> => {
        ...
        async function backgroundColourStatus(message: Message) {
            ...
            Background Opacity - ${userData[0].BackgroundColourOpacity === null ? `Not set.` : userData[0].BackgroundColourOpacity}`)
        ...
        async function lfmBoardStatus(message: Message) {
            ...
            LastFM Song Text Colour - ${userData[0].fmSongTextColour === null ? `Not set.` : userData[0].fmSongTextColour}
            LastFM Song Text Opacity - ${userData[0].fmSongTextOpacity === null ? `Not set.` : userData[0].fmSongTextOpacity}
            LastFM Artist Text Colour - ${userData[0].fmArtistTextColour === null ? `Not set.` : userData[0].fmArtistTextColour}
            LastFM Artist Text Opacity - ${userData[0].fmArtistTextColour === null ? `Not set.` : userData[0].fmArtistTextColour}`)
            return message.channel.send(statusEmbed)
        }
        ...
        async function setLfmBoardOpacity(message: Message, opacity: string) {
            ...
            if (opacity === 'reset') {
                ...
                return message.channel.send(`${message.author} your lastfm board background colour opacity has been successfully reset.`)
            } else {
                let validOpacityValue: boolean;
                let parseOpacity = Math.round(parseFloat(opacity))
                parseOpacity > 0 && parseOpacity < 100 ? validOpacityValue = true : validOpacityValue = false
        ...
        async function setLfmBoardColour(message: Message, colour: string) {
            ...
            if (colour === 'reset') {
                ...
                return message.channel.send(`${message.author} your lastfm board background colour has been successfully reset.`)
            } else {
                const hexTest = /^#[0-9A-F]{6}$/i.test(colour)
                if (hexTest !== true) {
                    return message.channel.send(`Your hex color is invalid. Try another one.`)
        ...
        async function setSongTextOpacity(message: Message, opacity: string) {
            ...
            if (opacity === 'reset') {
                ...
                return message.channel.send(`${message.author} your lastfm song text colour opacity has been successfully reset.`)
            } else {
                let validOpacityValue: boolean;
                let parseOpacity = Math.round(parseFloat(opacity))
                parseOpacity > 0 && parseOpacity < 100 ? validOpacityValue = true : validOpacityValue = false
        ...
        async function setArtistTextOpacity(message: Message, opacity: string) {
            ...
            if (opacity === 'reset') {
                ...
                return message.channel.send(`${message.author} your lastfm artist text colour opacity has been successfully reset.`)
            } else {
                let validOpacityValue: boolean;
                let parseOpacity = Math.round(parseFloat(opacity))
                parseOpacity > 0 && parseOpacity < 100 ? validOpacityValue = true : validOpacityValue = false
        ...
        async function xpBoardStatus(message: Message) {
            ...
            XP Text (2/right) Opacity - ${userData[0].xpText2Opacity === null ? `Not set.` : userData[0].fmArtistTextColour}
            XP Bar (1/left) Colour 1 - ${userData[0].xpDoneServerColour1 === null ? `Not set.` : userData[0].xpDoneServerColour1}
            XP Bar (1/left) Opacity 1 - ${userData[0].xpDoneServerColour1Opacity === null ? `Not set.` : userData[0].xpDoneServerColour1Opacity}
            XP Bar (1/left) Colour 2 - ${userData[0].xpDoneServerColour2 === null ? `Not set.` : userData[0].xpDoneServerColour2}
            XP Bar (1/left) Opacity 2 - ${userData[0].xpDoneServerColour2Opacity === null ? `Not set.` : userData[0].xpDoneServerColour2Opacity}
            XP Bar (1/left) Colour 3 - ${userData[0].xpDoneServerColour3 === null ? `Not set.` : userData[0].xpDoneServerColour3}
            XP Bar (1/left) Opacity 3 - ${userData[0].xpDoneServerColour3Opacity === null ? `Not set.` : userData[0].xpDoneServerColour3Opacity}
            XP Bar (2/right) Colour 1 - ${userData[0].xpDoneGlobalColour1 === null ? `Not set.` : userData[0].xpDoneGlobalColour1}
            XP Bar (2/right) Opacity 1 - ${userData[0].xpDoneGlobalColour1Opacity === null ? `Not set.` : userData[0].xpDoneGlobalColour1Opacity}
            XP Bar (2/right) Colour 2 - ${userData[0].xpDoneGlobalColour2 === null ? `Not set.` : userData[0].xpDoneGlobalColour2}
            XP Bar (2/right) Opacity 2 - ${userData[0].xpDoneGlobalColour2Opacity === null ? `Not set.` : userData[0].xpDoneGlobalColour2Opacity}
            XP Bar (2/right) Colour 3 - ${userData[0].xpDoneGlobalColour3 === null ? `Not set.` : userData[0].xpDoneGlobalColour3}
            XP Bar (2/right) Opacity 3 - ${userData[0].xpDoneGlobalColour3Opacity === null ? `Not set.` : userData[0].xpDoneGlobalColour3Opacity}`)
            return message.channel.send(statusEmbed)
        }
        ...
        async function setXPBoardOpacity(message: Message, opacity: string) {
            ...
            if (opacity === 'reset') {
                ...
                return message.channel.send(`${message.author} your xp board background colour opacity has been successfully reset.`)
            } else {
                let validOpacityValue: boolean;
                let parseOpacity = Math.round(parseFloat(opacity))
                parseOpacity > 0 && parseOpacity < 100 ? validOpacityValue = true : validOpacityValue = false
        ...
        async function setXPTextBothOpacity(message: Message, opacity: string) {
            ...
            if (opacity === 'reset') {
                ...
                return message.channel.send(`${message.author} both your xp board text colour opacity values has been successfully reset.`)
            } else {
                let validOpacityValue: boolean;
                let parseOpacity = Math.round(parseFloat(opacity))
                parseOpacity > 0 && parseOpacity < 100 ? validOpacityValue = true : validOpacityValue = false
                if (validOpacityValue === false) {
                    ...
                    await profile.update({xpTextOpacity: parseOpacity, xpText2Opacity: parseOpacity}, {where: {userID: userData[0].userID}})
                    return message.channel.send(`${message.author} both your xp board text colour opacity values has been successfully set.`)
                }
            }
        }
        ...
        async function setXPTextBothColour(message: Message, colour: string) {
            ...
            if (colour === 'reset') {
                ...
                if (hexTest !== true) {
                    ...
                    await profile.update({xpTextColour: colour, xpText2Colour: colour}, {where: {userID: userData[0].userID}})
        ...
        async function setXPTextOpacity(message: Message, opacity: string) {
            ...
            if (opacity === 'reset') {
                ...
                return message.channel.send(`${message.author} your xp board text (1/left) colour opacity has been successfully reset.`)
            } else {
                let validOpacityValue: boolean;
                let parseOpacity = Math.round(parseFloat(opacity))
                parseOpacity > 0 && parseOpacity < 100 ? validOpacityValue = true : validOpacityValue = false
        ...
        async function setXPText2Opacity(message: Message, opacity: string) {
            ...
            if (opacity === 'reset') {
                ...
                return message.channel.send(`${message.author} your xp board text (2/right) colour opacity has been successfully reset.`)
            } else {
                let validOpacityValue: boolean;
                let parseOpacity = Math.round(parseFloat(opacity))
                parseOpacity > 0 && parseOpacity < 100 ? validOpacityValue = true : validOpacityValue = false
        ...
        async function setXPText2Colour(message: Message, colour: string) {
            ...
            if (colour === 'reset') {
                ...
                return message.channel.send(`${message.author} your xp board text (2/right) colour has been successfully reset.`)
            } else {
                const hexTest = /^#[0-9A-F]{6}$/i.test(colour)
                if (hexTest !== true) {
                    return message.channel.send(`Your hex color is invalid. Try another one.`)
        ...
        async function setXPBarBothOpacity(message: Message, opacity1: string, opacity2: string, opacity3: string) {
            ...
            if (!opacity2 && opacity1 !== 'reset') return message.channel.send(`You need to either write reset or set 3 valid opacity values.`)
            if (!opacity3 && opacity1 !== 'reset') return message.channel.send(`You need to either write reset or set 3 valid opacity values.`)
            initModels(database);
            ...
            if (opacity1 === 'reset') {
                await profile.update({
                    ...
                    xpDoneGlobalColour3Opacity: null}, {where: {userID: userData[0].userID}})
                return message.channel.send(`${message.author} both your xp bar colour opacity values has been successfully reset.`)
            } else {
                ...
                await profile.update({
                    ...
                    xpDoneGlobalColour3Opacity: parseOpacity3}, {where: {userID: userData[0].userID}})
                return message.channel.send(`${message.author} both your xp bar colour opacity values has been successfully set.`)
            }
        }

        async function setXPBarBothColour(message: Message, colour1: string, colour2: string, colour3: string) {
            if (!colour1) return message.channel.send(`You need to either write reset or set a valid hex colour.\nRemember space between each hex colour.`)
            if (!colour2 && colour1 !== 'reset') return message.channel.send(`You need to either write reset or set a valid hex colour.\nRemember space between each hex colour.`)
            if (!colour3 && colour1 !== 'reset') return message.channel.send(`You need to either write reset or set a valid hex colour.\nRemember space between each hex colour.`)
        ...
        async function setXPBarOpacity(message: Message, opacity1: string, opacity2: string, opacity3: string) {
            ...
            if (opacity1 === 'reset') {
                await profile.update({
                    xpDoneServerColour1Opacity: null,
                    xpDoneServerColour2Opacity: null,
                    xpDoneServerColour3Opacity: null,}, {where: {userID: userData[0].userID}})
                return message.channel.send(`${message.author} your xp bar (1/left) colour opacity values has been successfully reset.`)
            } else {
                let validOpacityValue1: boolean;
                let validOpacityValue2: boolean;
                let validOpacityValue3: boolean;
                ...
                return message.channel.send(`${message.author} your xp bar (1/left) colour opacity values has been successfully set.`)
            }
        }
        ...
        async function setXPBar2Opacity(message: Message, opacity1: string, opacity2: string, opacity3: string) {
            ...
            if (opacity1 === 'reset') {
                await profile.update({
                    ...
                    xpDoneGlobalColour2Opacity: null,
                    xpDoneGlobalColour3Opacity: null}, {where: {userID: userData[0].userID}})
                return message.channel.send(`${message.author} your xp bar (2/right) colour opacity values has been successfully reset.`)
            } else {
                let validOpacityValue1: boolean;
                let validOpacityValue2: boolean;
                let validOpacityValue3: boolean;
                ...
                return message.channel.send(`${message.author} your xp bar (2/right) colour opacity values has been successfully set.`)
            }
        }
        ...
        async function descriptionStatus(message: Message) {
            ...
            Description Opacity - ${userData[0].descriptionColourOpacity === null ? `Not set.` : userData[0].descriptionColourOpacity}`)
            return message.channel.send(statusEmbed)
        }
        ...
        async function sidebarStatus(message: Message) {
            ...
            Discriminator Colour - ${userData[0].discriminatorColour === null ? `Not set.` : userData[0].discriminatorColour}
            ...
            Sidebar Server Rank Colour - ${userData[0].sidebarValueServerColour === null ? `Not set.` : userData[0].sidebarValueServerColour}
            Sidebar Global Rank Colour - ${userData[0].sidebarValueGlobalColour === null ? `Not set.` : userData[0].sidebarValueGlobalColour}
            Sidebar Bento Rank Colour - ${userData[0].sidebarValueBentoColour === null ? `Not set.` : userData[0].sidebarValueBentoColour}
            Sidebar Server Users Colour - ${userData[0].sidebarItemServerColour === null ? `Not set.` : userData[0].sidebarItemServerColour}
            Sidebar Global Users Colour - ${userData[0].sidebarItemGlobalColour === null ? `Not set.` : userData[0].sidebarItemGlobalColour}
            Sidebar Bento Users Colour - ${userData[0].sidebarItemBentoColour === null ? `Not set.` : userData[0].sidebarItemBentoColour}
            Sidebar Timezone Colour - ${userData[0].sidebarItemTimezoneColour === null ? `Not set.` : userData[0].sidebarItemTimezoneColour}`)
            return message.channel.send(statusEmbed)
        }
        
        async function setTimezone(message: Message, timezone: string) {
            if (!timezone) return message.channel.send(`You need to either write reset or set a valid timezone.\nThe structure is e.g. "Europe/Copenhagen"\nCheck the list here if you don't know how to write your timezone <https://en.wikipedia.org/wiki/List_of_tz_database_time_zones#List> `)
            initModels(database);
            ...
            if (timezone === 'reset') {
                ...
                if (timezoneTest !== true) {
                    return message.channel.send(`Your timezone is invalid.\nThe structure is e.g. "Europe/Copenhagen"\nCheck the list here if you don't know how to write your timezone <https://en.wikipedia.org/wiki/List_of_tz_database_time_zones#List> `)
                } else {
        ...
        async function setBirthday(message: Message, birthday: string) {
            if (!birthday) return message.channel.send(`You need to either write reset or set a valid birthday.\nThe structure is e.g. "25 November".`)
            initModels(database);
