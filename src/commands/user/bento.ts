                ...
                if (diffHours < hours && bentoData[1] === false) {
                    ...
                    if (patreonUser) {
                        if (patreonUser.follower === true) {
                            const targetIncrement = await bento.increment('bento', {by: 1*2, where: { userID: bentoDataTarget[0].userID}});
                            return message.channel.send(Util.removeMentions(`**${(await message.guild.members.fetch(message.author.id))?.nickname ? (await message.guild.members.fetch(message.author.id))?.nickname : message.author.username}** just gave 2 Bento 🍱 to 🌟 Official Patreon Bento 🍱 Follower 🌟 **${(await message.guild.members.fetch(mentionedUser.id))?.nickname ? `${(await message.guild.members.fetch(mentionedUser.id))?.nickname} (${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator})` : `${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator}`}**!\n**${(await message.guild.members.fetch(mentionedUser.id))?.nickname ? `${(await message.guild.members.fetch(mentionedUser.id))?.nickname} (${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator})` : `${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator}`}** has received **${targetIncrement[0][0][0].bento} Bento** 🍱 over time 😋\n**${(await message.guild.members.fetch(message.author.id))?.nickname ? (await message.guild.members.fetch(message.author.id))?.nickname : message.author.username}** can give a Bento 🍱 again in 12 hours.`))
                        } else if (patreonUser.enthusiast === true) {
                            const targetIncrement = await bento.increment('bento', {by: 1*3, where: { userID: bentoDataTarget[0].userID}});
                            return message.channel.send(Util.removeMentions(`**${(await message.guild.members.fetch(message.author.id))?.nickname ? (await message.guild.members.fetch(message.author.id))?.nickname : message.author.username}** just gave 3 Bento 🍱 to 🌟 Official Patreon Bento 🍱 Enthusiast 🌟 **${(await message.guild.members.fetch(mentionedUser.id))?.nickname ? `${(await message.guild.members.fetch(mentionedUser.id))?.nickname} (${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator})` : `${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator}`}**!\n**${(await message.guild.members.fetch(mentionedUser.id))?.nickname ? `${(await message.guild.members.fetch(mentionedUser.id))?.nickname} (${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator})` : `${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator}`}** has received **${targetIncrement[0][0][0].bento} Bento** 🍱 over time 😋\n**${(await message.guild.members.fetch(message.author.id))?.nickname ? (await message.guild.members.fetch(message.author.id))?.nickname : message.author.username}** can give a Bento 🍱 again in 12 hours.`))
                        } else if (patreonUser.disciple === true) {
                            const targetIncrement = await bento.increment('bento', {by: 1*4, where: { userID: bentoDataTarget[0].userID}});
                            return message.channel.send(Util.removeMentions(`**${(await message.guild.members.fetch(message.author.id))?.nickname ? (await message.guild.members.fetch(message.author.id))?.nickname : message.author.username}** just gave 4 Bento 🍱 to 🌟 Official Patreon Bento 🍱 Disciple 🌟 **${(await message.guild.members.fetch(mentionedUser.id))?.nickname ? `${(await message.guild.members.fetch(mentionedUser.id))?.nickname} (${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator})` : `${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator}`}**!\n**${(await message.guild.members.fetch(mentionedUser.id))?.nickname ? `${(await message.guild.members.fetch(mentionedUser.id))?.nickname} (${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator})` : `${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator}`}** has received **${targetIncrement[0][0][0].bento} Bento** 🍱 over time 😋\n**${(await message.guild.members.fetch(message.author.id))?.nickname ? (await message.guild.members.fetch(message.author.id))?.nickname : message.author.username}** can give a Bento 🍱 again in 12 hours.`))
                        } else if (patreonUser.sponsor === true) {
                            const targetIncrement = await bento.increment('bento', {by: 1*5, where: { userID: bentoDataTarget[0].userID}});
                            return message.channel.send(Util.removeMentions(`**${(await message.guild.members.fetch(message.author.id))?.nickname ? (await message.guild.members.fetch(message.author.id))?.nickname : message.author.username}** just gave 5 Bento 🍱 to 🌟 Official Patreon Bento 🍱 Sponsor 🌟 **${(await message.guild.members.fetch(mentionedUser.id))?.nickname ? `${(await message.guild.members.fetch(mentionedUser.id))?.nickname} (${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator})` : `${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator}`}**!\n**${(await message.guild.members.fetch(mentionedUser.id))?.nickname ? `${(await message.guild.members.fetch(mentionedUser.id))?.nickname} (${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator})` : `${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator}`}** has received **${targetIncrement[0][0][0].bento} Bento** 🍱 over time 😋\n**${(await message.guild.members.fetch(message.author.id))?.nickname ? (await message.guild.members.fetch(message.author.id))?.nickname : message.author.username}** can give a Bento 🍱 again in 12 hours.`))
                        } else {
                            const targetIncrement = await bento.increment('bento', {by: 1, where: { userID: bentoDataTarget[0].userID}});
                            return message.channel.send(Util.removeMentions(`**${(await message.guild.members.fetch(message.author.id))?.nickname ? (await message.guild.members.fetch(message.author.id))?.nickname : message.author.username}** just gave 1 Bento 🍱 to 🌟 Official Patreon Bento 🍱 Supporter 🌟 **${(await message.guild.members.fetch(mentionedUser.id))?.nickname ? `${(await message.guild.members.fetch(mentionedUser.id))?.nickname} (${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator})` : `${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator}`}**!\n**${(await message.guild.members.fetch(mentionedUser.id))?.nickname ? `${(await message.guild.members.fetch(mentionedUser.id))?.nickname} (${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator})` : `${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator}`}** has received **${targetIncrement[0][0][0].bento} Bento** 🍱 over time 😋\n**${(await message.guild.members.fetch(message.author.id))?.nickname ? (await message.guild.members.fetch(message.author.id))?.nickname : message.author.username}** can give a Bento 🍱 again in 12 hours.`))
                        }
                    } else {
                        const targetIncrement = await bento.increment('bento', {by: 1, where: { userID: bentoDataTarget[0].userID}});
