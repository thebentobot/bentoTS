...
import { initModels, bento, bentoCreationAttributes, guildMember, patreon } from '../../database/models/init-models';
                ...
                if (diffHours < hours && bentoData[1] === false) {
                    ...
                    if (patreonUser) {
                        if (patreonUser.follower === true) {
                            ...
                            return message.channel.send(Util.removeMentions(`**${(await message.guild.members.fetch(message.author.id)).nickname ? (await message.guild.members.fetch(message.author.id)).nickname : message.author.username}** just gave 3 Bento 🍱 to 🌟 Official Patreon Bento 🍱 Follower 🌟 **${(await message.guild.members.fetch(mentionedUser.id)).nickname ? `${(await message.guild.members.fetch(mentionedUser.id)).nickname} (${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator})` : `${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator}`}**!\n**${(await message.guild.members.fetch(mentionedUser.id)).nickname ? `${(await message.guild.members.fetch(mentionedUser.id)).nickname} (${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator})` : `${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator}`}** has received **${targetIncrement[0][0][0].bento} Bento** 🍱 over time 😋\n**${(await message.guild.members.fetch(message.author.id)).nickname ? (await message.guild.members.fetch(message.author.id)).nickname : message.author.username}** can give a Bento 🍱 again in 12 hours.`))
                            ...
                            return message.channel.send(Util.removeMentions(`**${(await message.guild.members.fetch(message.author.id)).nickname ? (await message.guild.members.fetch(message.author.id)).nickname : message.author.username}** just gave 4 Bento 🍱 to 🌟 Official Patreon Bento 🍱 Enthusiast 🌟 **${(await message.guild.members.fetch(mentionedUser.id)).nickname ? `${(await message.guild.members.fetch(mentionedUser.id)).nickname} (${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator})` : `${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator}`}**!\n**${(await message.guild.members.fetch(mentionedUser.id)).nickname ? `${(await message.guild.members.fetch(mentionedUser.id)).nickname} (${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator})` : `${(await message.guild.members.fetch(mentionedUser.id)).user.username}#${(await message.guild.members.fetch(mentionedUser.id)).user.discriminator}`}** has received **${targetIncrement[0][0][0].bento} Bento** 🍱 over time 😋\n**${(await message.guild.members.fetch(message.author.id)).nickname ? (await message.guild.members.fetch(message.author.id)).nickname : message.author.username}** can give a Bento 🍱 again in 12 hours.`))
