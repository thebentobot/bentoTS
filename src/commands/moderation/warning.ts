    ...
    run: async (client, message, args): Promise<Message> => {
        ...
        try {
            ...
            try {
                ...
                await message.channel.send(`**${message.guild.members.cache.get(`${warningUserID}`).nickname ? `${message.guild.members.cache.get(`${warningUserID}`).nickname} (${message.guild.members.cache.get(`${warningUserID}`).user.username + '#' + message.guild.members.cache.get(`${warningUserID}`).user.discriminator})` : `${message.guild.members.cache.get(`${warningUserID}`).user.username + '#' + message.guild.members.cache.get(`${warningUserID}`).user.discriminator}`}** was successfully **warned**.\n**Case number: ${warned.warningCase}**.\n**Reason:** ${reason}\nYou can add notes for this warning by using the case command, together with the case number.`)
            } catch {
                await message.channel.send(`**${message.guild.members.cache.get(`${warningUserID}`).nickname ? `${message.guild.members.cache.get(`${warningUserID}`).nickname} (${message.guild.members.cache.get(`${warningUserID}`).user.username + '#' + message.guild.members.cache.get(`${warningUserID}`).user.discriminator})` : `${message.guild.members.cache.get(`${warningUserID}`).user.username + '#' + message.guild.members.cache.get(`${warningUserID}`).user.discriminator}`}** was successfully **warned**.\n**Case number: ${warned.warningCase}**.\n**Reason:** ${reason}\nYou can add notes for this warning by using the case command, together with the case number.`)
            }
        } catch {
