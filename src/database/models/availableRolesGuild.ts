...
export class availableRolesGuild extends Model<availableRolesGuildAttributes, availableRolesGuildCreationAttributes> implements availableRolesGuildAttributes {
  role!: string;
  id?: number;
  guildID!: bigint;
  type!: "main" | "sub" | "other";
